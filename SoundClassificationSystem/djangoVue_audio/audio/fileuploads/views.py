...
def proceedAudio(request):
    ...
    path="D:/1Disertatie/1App/djangoVue_audio/audio/media/uploads/"+selectionObj["filename"]
    if(selectionObj["sound_type"] == 'environmental'):
        ...
        if(selectionObj["sound_representation"] == 'vgg'):
           model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/Urban/VGG_UrbanPretrainedIMageNet3.h5')
        ...
        if(selectionObj["sound_representation"] == 'imageProcesing'):
           if(selectionObj["image_representation"] == 'mel'):
              model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/Urban/CNN_melSpec_100Acc0.87.h5')
              classindex= predict_audio_classIMG_MEL(path,model)
           if(selectionObj["image_representation"] == 'chroma'):
              model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/Urban/CNN_chromaCQT_100Acc0.62.h5')
              classindex= predict_audio_classIMG_CQT(path,model)
           if(selectionObj["image_representation"] == 'chromaCens'):
              model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/Urban/CNN_chromaCENS_100Acc0.5787.h5')
    ...
    if(selectionObj["sound_type"] == 'music'):        
        ...
        if(selectionObj["sound_representation"] == 'imageProcesing'):
           if(selectionObj["image_representation"] == 'mel'):
              model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/fma/CNN_fma_melspec_900Acc0.61.h5')
              classindex= predict_audio_classIMG_MEL2(path,model)
           if(selectionObj["image_representation"] == 'chroma'):
              model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/fma/CNN_fma_cqt_Acc0.2962.h5')
              classindex= predict_audio_classIMG_CQT(path,model)
           if(selectionObj["image_representation"] == 'chromaCens'):
              model= load_model('C:/Users/User/OneDrive/Desktop/Disertatie/CNN/BestModels/fma/CNN_fma_cens_Acc0.2812.h5')
              classindex= predict_audio_classIMG_CENS(path,model)
...
def predict_audio_classIMG_MEL2(file_path, model):
    ...
    # Reshape the features to fit the input shape of the model
    features.append(melspec_scaled)
    features =  np.array([x.reshape( (12, 1, 128 // 128) ) for x in features])
    # Predict the class
    predicted_vector = model.predict(features)
    predicted_class_index = np.argmax(predicted_vector, axis=-1)
